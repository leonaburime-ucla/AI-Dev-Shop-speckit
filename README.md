...
**Slash commands (Claude Code)** — copy the command templates once to activate `/blueprint`, `/spec`, `/plan`, `/tasks`, `/implement`, `/review`, `/clarify`, `/consensus`:
```bash
...
open `AI-Dev-Shop-speckit/slash-commands/<command>.md`, copy the contents, and paste as your prompt.
...
- **Slash commands** — `/blueprint`, `/spec`, `/clarify`, `/plan`, `/tasks`, `/implement`, `/review`, `/consensus` as executable commands (see `slash-commands/`).
...
├── slash-commands/                ← Slash command source files (copy to .claude/commands/)
│   ├── spec.md      → /spec
...
│   ├── codebase-analyzer/
│   ├── coordinator/
│   ├── system-blueprint/          ← Macro system planning before feature specs
│   ├── spec/
│   ├── red-team/
│   ├── architect/
│   ├── tdd/
...
│   ├── system-blueprint/SKILL.md  ← Macro system blueprinting and spec decomposition
...
│   ├── examples/                  ← Project examples and golden samples
│   ├── guides/                    ← Project guides and planning docs
...
| System Blueprint (optional pre-spec) | Produces a macro system blueprint and spec decomposition plan before detailed specs |
