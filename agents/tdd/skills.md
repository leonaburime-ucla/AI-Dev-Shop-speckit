...
- `<AI_DEV_SHOP_ROOT>/project-knowledge/quality/react-component-testing-policy.md` — enforces component detection and required tests (render, interaction, a11y, edge cases)
