...
7. Write ADR to `<SHOP_ROOT>/specs/<NNN>-<feature-name>/adr.md` using `<SHOP_ROOT>/templates/adr-template.md`. Complete the Constitution Check table, Research Summary field, and Complexity Justification table.
