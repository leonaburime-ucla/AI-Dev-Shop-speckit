...
7. Write ADR to `<AI_DEV_SHOP_ROOT>/reports/pipeline/<NNN>-<feature-name>/adr.md` using `<AI_DEV_SHOP_ROOT>/templates/adr-template.md`. Complete the Constitution Check table, Research Summary field, and Complexity Justification table.
