...
## Workflow
1. Review each finding from Code Review using the taxonomy in `<AI_DEV_SHOP_ROOT>/skills/refactor-patterns/SKILL.md`.
...
4. Write proposals in the format defined in `<AI_DEV_SHOP_ROOT>/skills/refactor-patterns/SKILL.md`.
