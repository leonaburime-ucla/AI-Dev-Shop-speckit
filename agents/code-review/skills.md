...
- Architecture constraints (relevant ADRs from `<AI_DEV_SHOP_ROOT>/reports/pipeline/<NNN>-<feature-name>/`)
...
Write findings to `<AI_DEV_SHOP_ROOT>/reports/code-review/CR-<feature-id>-<YYYY-MM-DD>.md`.
