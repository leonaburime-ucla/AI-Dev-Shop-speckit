...
- Log thread summary to `<AI_DEV_SHOP_ROOT>/project-knowledge/reports/pipeline/<NNN>-<feature-name>/consultation-log.md`.
...
│                 Context: `<AI_DEV_SHOP_ROOT>/project-knowledge/reports/pipeline/<NNN>-<feature-name>/coverage-triage-<YYYY-MM-DD>.md`,
