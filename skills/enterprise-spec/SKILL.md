...
Program-level spec location: `<AI_DEV_SHOP_ROOT>/specs/programs/<program-id>/<feature-spec-id>/feature.spec.md`
...
Program spec location: `<AI_DEV_SHOP_ROOT>/specs/programs/<program-id>/program.spec.md`
